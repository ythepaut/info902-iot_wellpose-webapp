...
function OptionsButton(props: Props): JSX.Element {
    ...
    useEffect(() => {
        const handleClick = (e: MouseEvent) => {
            ...
            if (
                e.pageX < bounds.x ||
                e.pageX > bounds.x + bounds.width ||
                e.pageY < bounds.y ||
                e.pageY > bounds.y + bounds.height
            )
    ...
    return (
        <>
            <Button
                ...
                type="soft"
                colour="dark"
                className="context pl-4 pr-4 pt-2 pb-2 text-txt-body-muted bg-bg hover:bg-grey-400 active:bg-grey-500"
                onClick={(_) => {
