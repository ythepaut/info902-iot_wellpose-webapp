...
export function Heading4({ children, className }: Props): JSX.Element {
    return <h4 className={`text-md font-bold ${className}`}>{children}</h4>;
}
export function Heading5({ children, className }: Props): JSX.Element {
    return <h5 className={`text-sm font-semibold ${className}`}>{children}</h5>;
}
export function Heading6({ children, className }: Props): JSX.Element {
    return <h6 className={`text-xs font-semibold ${className}`}>{children}</h6>;
}
